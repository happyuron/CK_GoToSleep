...
public struct AnimationInfo<T>
{
    ...
    [field: SerializeField] public bool DoFade { get; private set; }

    [field: SerializeField] public Vector2 StartPosition { get; private set; }

    [field: SerializeField] public Vector2 StartScale { get; private set; }
    ...
    [field: NonSerialized] public Vector2 DefaultPosition { get; set; }
